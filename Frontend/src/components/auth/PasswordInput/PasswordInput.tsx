...
export default function PasswordInput({ placeholder, autoComplete }: PasswordInputProps) {
		...
		<div className={styles['auth-form__input-field']}>
			...
			<button
				...
				<img
					src={
						isPasswordVisible
							? '/img/icons/auth/password-visible.svg'
							: '/img/icons/auth/password-hidden.svg'
					}
					alt=''
					aria-hidden='true'
